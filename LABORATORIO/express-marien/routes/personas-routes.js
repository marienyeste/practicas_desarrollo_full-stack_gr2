...
const valid_user = [
    ...
    .isISO8601(),
    check('colorFavorito', 'El color favorito indicado debe tener al menos 3 caracteres y no puede incluir números')
    .isLength({
        min: 3
    })
    .isAlpha(locale = 'es-ES', {
...
// Método GET by Id:
router.get('/:id', users_controller.users_list_one);
